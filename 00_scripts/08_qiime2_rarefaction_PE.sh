...
WORKING_DIRECTORY=/scratch_vol0/fungi/BIOREMHALO/05_QIIME2
...
# Note: max-depth should be chosen based on ConTable.qzv (or on /scratch_vol0/fungi/BIOREMHALO/05_QIIME2/export/visual/ConTable/sample-frequency-detail.csv)
